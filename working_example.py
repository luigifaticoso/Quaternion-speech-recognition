...
if(params.model in ['QCNN' , 'QDNN']):
    x_train, y_train = dataPrepDecodaQuaternion('files_for_neural_gigi/TRAIN_BIG_PEZZO_DI_DATA_processed.data',isquat=True)
    x_dev,   y_dev   = dataPrepDecodaQuaternion('files_for_neural_gigi/DEV_BIG_PEZZO_DI_DATA_processed.data',  isquat=True)
    x_test,  y_test  = dataPrepDecodaQuaternion('files_for_neural_gigi/TEST_BIG_PEZZO_DI_DATA_processed.data', isquat=True)
else:
    x_train, y_train = dataPrepDecodaQuaternion('files_for_neural_gigi/TRAIN_BIG_PEZZO_DI_DATA_processed.data',isquat=False)
    x_dev,   y_dev   = dataPrepDecodaQuaternion('files_for_neural_gigi/DEV_BIG_PEZZO_DI_DATA_processed.data',  isquat=False)
    x_test,  y_test  = dataPrepDecodaQuaternion('files_for_neural_gigi/TEST_BIG_PEZZO_DI_DATA_processed.data', isquat=False)
